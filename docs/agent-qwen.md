...
own. It is the pre-ward#401 roster key: `--driver qwen` / `--mode qwen` still
...
- [agent-adapter-manifest.md](agent-adapter-manifest.md) - the roster entry, renamed from `qwen` by ward#401.
