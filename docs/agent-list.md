...
- It shows which runs are active right now, including reservation-backed launches before their container appears, while dropping stale prelaunch holds after the launch-confirmation TTL, and it shows how much engineer capacity remains when the limit is known.
