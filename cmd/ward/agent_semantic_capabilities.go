...
func semanticCapabilitiesForRole(role string) semanticCapabilitySet {
	switch role {
	case roleAdvisor, roleQA:
		return semanticCapabilities(semanticCapabilityRead)
	case roleDirector:
		return semanticCapabilities(semanticCapabilityRead, semanticCapabilityProjectManagement)
	case roleEngineer:
		return semanticCapabilities(semanticCapabilityRead, semanticCapabilityEngineering)
	case roleOps:
