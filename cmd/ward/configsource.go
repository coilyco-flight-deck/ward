...
const (
	// The compatibility monolith mirrors the baked source's flattened guardfile path.
	// ward loads it via byte-Parse, so the runtime surface must not inherit across files.
