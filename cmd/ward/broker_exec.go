...
// writeTierAuthorizer is the broker.Authorizer for write allowlist and owner scope.
// Comment writes fail closed while a live engineer or fresh reservation owns the issue.
