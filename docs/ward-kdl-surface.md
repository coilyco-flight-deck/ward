...
- **`ward-kdl pkg <resource> <verb>`** - `specverb` package-directory lookups: **skillsmp** (skills) and **glama** (Glama MCP), from `coily pkg`. See [skillsmp](ward-kdl/ward-kdl.skillsmp.guardfile.md), [glama](ward-kdl/ward-kdl.glama.guardfile.md).
