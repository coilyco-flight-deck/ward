...
ward#401; renamed from `agentspi` in ward#425). It is a **types-only,
...
- **Phase 3 (ward#425)** drained every per-agent body **home**: the closures are
...
switches (ward#152). The drain ratchet `agent_drain_gate_test.go` fails if a
