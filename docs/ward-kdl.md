...
- **Smart defaults bundle** - `ward-kdl.defaults.kdl`: launch-selected runtime policy defaults for the edge bundle path. Parsed by ward at launch, embedded via `defaultsassets/`.
