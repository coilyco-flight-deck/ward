...
- [`warded director`](agent-director.md) - Opens the read-only director surface. Autonomous burndown is opt-in. Modes: Attached read-only control surface over a repo backlog. Use --burndown or --drain for the autonomous heartbeat.
