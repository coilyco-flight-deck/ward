...
func TestAgentSeedPromptWorkflow(t *testing.T) {
	...
	direct := agentSeedPromptWorkflow(ref, "reframe ward", "do it", "", true, nil, workflowDirectMain)
	...
	pr := agentSeedPromptWorkflow(ref, "reframe ward", "do it", "", true, nil, workflowPR)
	...
	patch := agentSeedPromptWorkflow(ref, "reframe ward", "do it", "", true, nil, workflowPatchOnly)
