...
**Auth smoke test ([ward#222](https://forgejo.coilysiren.me/coilyco-flight-deck/ward/issues/222)).** A headless claude whose seeded credential cannot
...
**Env scrub after seeding ([ward#357](https://forgejo.coilysiren.me/coilyco-flight-deck/ward/issues/357)).** `WARD_CLAUDE_CREDS_B64` /
...
**codex** ([ward#178](https://forgejo.coilysiren.me/coilyco-flight-deck/ward/issues/178)) follows the same shape: ward injects the host's
...
- [docs/forgejo-git-auth.md](forgejo-git-auth.md) - the Forgejo bot token path.
- [docs/github-token.md](github-token.md) - the GitHub-side token path for GitHub issue refs.
