...
- **Retired setup/doctor inventory** - the removed onboarding/diagnostic pair
  used to cross-check `commands.<name>` and summarize `security:`. See
  [release-planning-setup-doctor.md](release-planning-setup-doctor.md).
