...
- It shows which runs are active right now, including reservation-backed launches before their container appears, and how much engineer capacity remains when the limit is known.
