...
Repository-alias detail for [`../SKILL.md`](../SKILL.md).

## Parse rules

Recognize `[ward ]agent <role>? <owner-tokens> <repo-tokens>
[issue|number|ticket|hash|pound|#] <N>` or an ordinary dispatch phrase with
the same repository and numeric tail.
